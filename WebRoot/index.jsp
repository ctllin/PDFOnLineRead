...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	//request.getRequestDispatcher("web/viewer.html").forward(request, response);
	//response.sendRedirect("web/viewer.html");
%>
...
<BODY>
	...
	<DIV id="IfNoAcrobat" style="display:none">
		你需要先安装Adobe Reader才能正常浏览文件，请点击<a
			href=http://get.adobe.com/cn/reader/download/?installer=Reader_11.0_Chinese_Simplified_for_Windows
			target="_blank">这里</a>下载Adobe Reader.
	</DIV>
	...
	<DIV id=showdiv
		...
		<object classid="clsid:CA8A9780-280D-11CF-A24D-444553540000"
			...
			<param name="SRC" value="web/scj.pdf">
		</object>
	</DIV>
</BODY>
</HTML>
